...
const NewProductsPage = () => {
  ...
  const [categories, setCategories] = useState([]); // Adicionado para armazenar as categorias
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        {loading ? (
          ...
          <div className="relative">
            ...
            {/* Grid de produtos com transição */}
            <div
              className={`grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-12 transition-opacity duration-300 ${
